...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "#flickr-container {\r\n    border: 1px solid #cccccc;\r\n    min-height: 500px;\r\n    padding: 20px;\r\n    margin-top: 10px;\r\n    margin-bottom: 10px;\r\n    width: 90%;\r\n    margin: auto;\r\n}\r\n\r\n.flickr-photos {\r\n    width: 95%;\r\n    padding: 10px;\r\n    margin: auto;\r\n   position: relative;\r\n}\r\n\r\n.flickr-photo {\r\n    display: inline-block;\r\n    width: 75px;\r\n    border: 1px solid #cccccc;\r\n    margin: 5px;\r\n    height: 75px;\r\n    background-position: center;\r\n    overflow: hidden;\r\n}\r\n\r\n#flickr-container .loader {\r\n    text-align: center;\r\n    position: absolute;\r\n    top: 50%;\r\n    left: 50%;\r\n}\r\n\r\n#flickr-container .pages {\r\n    text-align: center;\r\n}\r\n\r\n#flickr-container .pages .page {\r\n    display: inline-block;\r\n    margin: 3px;\r\n\r\n}\r\n\r\n#flickr-container .pages-of-pages {\r\n    margin: 5px;\r\n}\r\n\r\n.prev, .next {\r\n    position: absolute;\r\n    top: 50%;\r\n}\r\n\r\n.prev {\r\n    left: 20;\r\n}\r\n\r\n.next {\r\n    right: 20;\r\n}\r\n\r\n.detailedPhoto {\r\n    text-align: center;\r\n    min-height: 400px;\r\n}\r\n\r\n.pagination > li.current a {\r\n    background-color: #cccccc;\r\n}\r\n\r\n.paginationWrapper{\r\n    text-align: center;\r\n}\r\n\r\n#loaderWrapper{\r\n    position: relative;\r\n    min-height: 400px;\r\n}\r\n\r\n#loader{\r\n    position: absolute;\r\n    top:50%;\r\n    left:50%;\r\n}", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PhotoList = __webpack_require__(173);
	...
	var _Flickr = __webpack_require__(177);
	...
	var App = function (_React$Component) {
	    ...
	    function App(props) {
	        ...
	        _this.service = new _Flickr2.default();
	        _this.state = {
	            query: '',
	            page: 1,
	            loading: true,
	        ...
	        window.addEventListener("hashchange", _this._onLocationChange.bind(_this));
	        return _this;
	    }

	    _createClass(App, [{
	        key: '_onLocationChange',
	        value: function _onLocationChange() {
	        ...
	        key: '_onQueryChange',
	        value: function _onQueryChange(event) {
	        ...
	        value: function render() {
	            ...
	            if (this.state.loading === true) {
	                content = _react2.default.createElement(
	                    'div',
	                    { id: 'loaderWrapper' },
	                    _react2.default.createElement('img', { id: 'loader', src: 'images/loader.gif' })
	                );
	            } else {
	                content = _react2.default.createElement(
	                    'div',
	                    null,
	                    _react2.default.createElement(_Paginator2.default, { page: this.state.page, totalPages: this.pages,
	                        onChange: this._onPageChange.bind(this) }),
	                    _react2.default.createElement(_PhotoList2.default, { photos: this.photos }),
	                    _react2.default.createElement(_Paginator2.default, { page: this.state.page, totalPages: this.pages,
	                        onChange: this._onPageChange.bind(this) })
	                );
	            }
	            ...
	            if (this.state.currentPhotoId !== undefined && this.photos !== undefined && this.photos.length > 0) {
	                ...
	                modal = _react2.default.createElement(_Modal2.default, { photos: this.photos, currentPhotoId: this.state.currentPhotoId });
	            }
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                ...
	                                _react2.default.createElement(
	                                    ...
	                                    _react2.default.createElement(
	                                        ...
	                                        _react2.default.createElement(
	                                            'label',
	                                            { className: 'sr-only', 'for': 'flickr-search' },
	                                            'Email address'
	                                        ),
	                                        _react2.default.createElement('input', {
	                                            className: 'form-control', id: 'flickr-search', placeholder: 'search',
	                                            value: this.state.query, onChange: this._onQueryChange.bind(this), onKeyPress: this._onKeyPress.bind(this) })
	                                    ),
	                                    _react2.default.createElement(
	                                        'div',
	                                        { className: 'form-group' },
	                                        _react2.default.createElement(
	                                            'button',
	                                            { type: 'button', className: 'btn btn-default', id: 'flickr-search-button',
	                            ...
	                            _react2.default.createElement(
	                                'div',
	                                { className: 'col-md-5' },
	                                _react2.default.createElement('div', { className: 'pages' })
	                            ),
	                            _react2.default.createElement(
	                                'div',
	                                { className: 'col-md-2' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Photo = __webpack_require__(174);
	...
	var PhotoList = function (_React$Component) {
	    ...
	    function PhotoList() {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(PhotoList).apply(this, arguments));
	    }
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                this.props.photos.map(function (photo, index) {
	                    return _react2.default.createElement(_Photo2.default, { key: index, data: photo });
	                }.bind(this))
	            );
	        }
	    }]);
	    ...
	    _createClass(Photo, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'a',
	                    { href: "#photo/" + this.props.data.id },
	                    _react2.default.createElement('img', { className: 'alpha', src: src })
	                )
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Pagination = function (_React$Component) {
	    ...
	    _createClass(Pagination, [{
	        key: '_onPageChange',
	        value: function _onPageChange(event) {
	            event.preventDefault();
	            this.setState({
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    pageNav.map(function (page, index) {
	                        return _react2.default.createElement(
	                            'li',
	                            { className: page.current ? 'current' : '', key: index },
	                            _react2.default.createElement(
	                                'a',
	                                { href: '#', onClick: this._onPageChange.bind(this),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Modal = function (_React$Component) {
	    ...
	    _createClass(Modal, [{
	        ...
	        key: 'getPreviousPhotoId',
	        value: function getPreviousPhotoId() {
	            var photoIndex = this.props.photos.indexOf(this.photo);
	            if (photoIndex !== -1 && this.props.photos[photoIndex - 1] !== undefined) {
	                return this.props.photos[photoIndex - 1].id;
	            }
	        ...
	        value: function render() {
	            ...
	            if (this.props.photos[photoIndex + 1] !== undefined) {
	                next = _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'a',
	                        { href: '#photo/' + this.props.photos[photoIndex + 1].id, className: 'btn btn-default btn-lg' },
	            ...
	            return _react2.default.createElement(
	                'div',
	                { className: 'modal fade photoModal', id: 'modal', tabindex: '-1', role: 'dialog',
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                ...
	                                _react2.default.createElement(
	                                    'a',
	                                    {
	                                        href: 'http://www.flickr.com/photos/96025815@N05/26540743544', target: '_blank' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["$"] = __webpack_require__(180);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["jQuery"] = __webpack_require__(178);
	/* WEBPACK VAR INJECTION */}.call(exports, (function() { return this; }())))
